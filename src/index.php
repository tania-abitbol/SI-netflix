...
<?php include("./components/header.php")?>
  ...
  <!-- 
    <div class="slider slider--list">
      <div class="slider__item">Test</div>
      <div class="slider__item">Test</div>
      <div class="slider__item">Test</div>
      <div class="slider__item">Test</div>
      <div class="slider__item">Test</div>
  ...
  <div class="container">
    <div class="slider__icon">
      <div class="slider__icon--container">
        <svg class="prev" width="30" height="24" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fill="black" stroke="#F0EDEE" />
        </svg>
      </div>
      <div class="slider__icon--second">
        <svg class="next" width="30" height="24" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div class="sliders__inner">
        <div class="sliders__item">
          <div class="sliders__item--media">
            <img class="sliders__item--img" src="/assets/images/iphonetest.jpg" alt="" />
          </div>
  ...
  <!-- <div class="video">
      ...
      <div class="video__controller">
        <button class="video__controller--play">Play/Pause</button>
